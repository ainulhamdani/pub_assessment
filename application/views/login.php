...
<script>(function(d, s, id) {
  ...
  js.src = 'https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.12&appId=1722550147790150';
...
<div class="row justify-content-center">
  <div class="col-lg-3 col-md-6 col-sm-6">
    <center><fb:login-button scope="public_profile,email" class="fb-login-button" onlogin="onLogIn()" data-width="250" data-height="50" data-max-rows="1" data-size="large" data-button-type="login_with" data-show-faces="false" data-use-continue-as="false"></fb:login-button></center>
  </div>
</div>
<div class="row"><hr></div>
