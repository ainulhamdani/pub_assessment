    ...
    <div class="col-md-12">
    	<form action="<?=base_url()?>assessment/savetask" method="POST">
    		...
    		<div class="row form-group">
    			<div class="col-md-3 col-sm-3 col-xs-12">Kode</div>
    			<div class="col-md-9 col-sm-9 col-xs-12"><input class="form-control" type="text" name="code" /></div>
    		</div>
    		<div class="row form-group">
    			<div class="col-md-3 col-sm-3 col-xs-12">Task</div>
    			<div class="col-md-9 col-sm-9 col-xs-12">
    				<textarea name="value" class="form-control"></textarea>
    			</div>
    		</div>
    		<div class="row form-group">
	    		<div class="col-md-3-offset-3 col-sm-12 col-xs-12">
