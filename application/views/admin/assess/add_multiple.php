...
?>
	<div class="page-header">
        <h1><?=$assessment->name?><small> add multiple</small></h1>
    </div>
    <hr>
    <?php if($assessment->type==2) { redirect("assessment/add_task/".$assessment->id); ?>
    <div class="row">
	    <div class="col-md-12">
    ...
    <div class="row">
	    <div class="col-md-12">
	    	<form action="<?=base_url()?>assessment/savetasks" method="POST" enctype="multipart/form-data">
	    		<input type="hidden" name="id" value="<?=$assessment->id?>" />
	    		<input type="hidden" name="type" value="1" />
	    		<div class="row form-group">
	    			<div class="col-md-3 col-sm-3 col-12">Kode</div>
	    			<div class="col-md-9 col-sm-9 col-12">Make sure files name you upload changed into its code</div>
	    		</div>
	    		<div class="row form-group">
	    			<div class="col-md-3 col-sm-3 col-12">Task</div>
	    			<div class="col-md-9 col-sm-9 col-12">
	    				<input class="form-control-file" type="file" name="userFiles[]" multiple />
	    			</div>
	    		</div>
	    		<div class="row form-group">
		    		<div class="col-md-3-offset-3 col-sm-12 col-12">
